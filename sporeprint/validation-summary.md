...
description = "Defense meta-primal — metadata-only threat detection, lineage verification, composable anomaly primitives, Tower HTTP advisory. 540 tests, 29 IPC methods."
date = 2026-07-04
