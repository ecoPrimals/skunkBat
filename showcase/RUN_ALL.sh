...
echo "╚══════════════════════════════════════════════════════════════════════════════╝"
echo ""
echo "This will run ALL 16 demos across 4 levels."
...
echo ""
echo "2. Four Violation Types"
echo "   • Genetic (WHO): Cryptographic lineage via Beardog"
...
echo ""
echo "Ready to deploy? See ../README.md and docs/ for next steps!"
echo ""
