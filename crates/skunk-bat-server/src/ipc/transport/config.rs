...
pub struct BtspConfig {
    ...
    #[allow(dead_code, reason = "config API — used by log_mode")]
    pub insecure: bool,
}
...
impl BtspConfig {
    ...
    #[cfg(unix)]
    #[allow(dead_code, reason = "config API — available for symlink creation")]
    ...
    #[cfg(unix)]
    #[allow(dead_code, reason = "config API — available for diagnostics")]
